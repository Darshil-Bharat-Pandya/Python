...
# Example: The first two lines will print the type of the boolean values True and False, which is <class 'bool'>. The third line will cause an error, because true is not a valid keyword in Python. Python is a case-sensitive, which means it distinguishes between uppercase and lowercase letters. We need to capitalize the first letter of true to make it a boolean value.
